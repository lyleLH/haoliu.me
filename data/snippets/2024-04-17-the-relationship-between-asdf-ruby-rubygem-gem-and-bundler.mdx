---
icon: 'Ruby'
heading: 'The Relationship Between asdf, Ruby, RubyGem, gem, and Bundler'
title: 'The Relationship Between asdf, Ruby, RubyGem, gem, and Bundler'
date: '2024-04-17'
tags: ['Basic Concepts', 'Ruby', 'RubyGem']
draft: false
summary: '向 ChatGPT3.5 提问, 你能向我解释一下 bundler gem 和ruby之间的关系吗?'
images: ['https://raw.githubusercontent.com/rubygems/rubygems.org/master/doc/ruby_central_logo.png']
authors: ['default']
---
