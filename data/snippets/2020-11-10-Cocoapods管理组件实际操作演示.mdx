---
icon: 'Cocoapods'
heading: 'Cocoapods管理组件实际操作演示'
title: 'Cocoapods管理组件实际操作演示'
date: '2020-11-10'
tags: ['cocoapods', 'best practice', 'Develop Tools']
draft: false
summary: '目前我们的项目工程使用 cocoapods 来管理依赖，同时我们对项目进行组件化的时候，cocoapods 也是必要的组件生命周期管理工具。'
images:
  [
    'https://camo.githubusercontent.com/e280b6b4e00abcb09152da611725a79374c03cd8c262a8662ce9eb64aaad5f60/68747470733a2f2f7261772e6769746875622e636f6d2f436f636f61506f64732f7368617265645f7265736f75726365732f6d61737465722f6173736574732f636f636f61706f64732d62616e6e65722d726561646d652e706e67',
  ]
authors: ['default']
---
